...
//弱引用/强引用
#define JWWeakSelf(type)  __weak typeof(type) weak##type = type;
#define JWStrongSelf(type)  __strong typeof(type) type = weak##type;
...
//开发Log
#ifdef DEBUG
#define JWLog(...) NSLog(@"%s 第%d行 \n %@\n\n",__func__,__LINE__,[NSString stringWithFormat:__VA_ARGS__])
#else
#define JWLog(...)
#endif

//设置 view 圆角和边框
#define JWViewBorderRadius(View, Radius, Width, Color)\
\
...
//获取当前语言
#define JWCurrentLanguage ([[NSLocale preferredLanguages] objectAtIndex:0])
